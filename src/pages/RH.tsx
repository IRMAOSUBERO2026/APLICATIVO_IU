...
import { Search, Upload, AlertTriangle, MessageCircle, UserPlus, FolderOpen, Stethoscope } from "lucide-react";
...
export default function RH() {
  ...
  useEffect(() => {
    supabase.from("funcionarios").select("id, nome, cpf, cargo, empresa_id, status, salario_base, salario_combinado, data_admissao, data_aso, data_nr6, data_nr12, data_nr18, data_nr35, foto_url, codigo_pix, banco, agencia, conta, tipo_conta")
