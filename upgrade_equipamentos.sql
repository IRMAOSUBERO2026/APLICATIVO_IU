...
ALTER TABLE public.equipamentos_proprios ADD COLUMN IF NOT EXISTS foto_url TEXT NULL;

-- 2. GARANTIR CAMPOS DE CUSTO NA MANUTENÇÃO
ALTER TABLE public.manutencoes_equipamento ADD COLUMN IF NOT EXISTS valor_orcamento NUMERIC DEFAULT 0;
ALTER TABLE public.manutencoes_equipamento ADD COLUMN IF NOT EXISTS valor_aprovado NUMERIC DEFAULT 0;

-- 3. CRIAR TABELA DE HISTÓRICO DE ALOCAÇÃO
